...
import gitam from './assets/education_logo/gitam.jpg';
import srichaitanya from './assets/education_logo/srichaitanya.jpg';
import bhashyam from './assets/education_logo/bhashyam.png';
...
export const SkillsInfo = [
  ...
  export const education = [
    ...
    },
    {
      id: 1,
      img: srichaitanya,
      school: "Sri Chaitanya junior College, Gajuwaka",
      date: "Sept 2020 - Aug 2022",
      grade: "86%",
      desc: "I completed my Intermediate (MPC) at Sri Chaitanya Junior College, Visakhapatnam, with a focus on Mathematics, Physics, and Chemistry. This course strengthened my analytical and logical reasoning skills, while also building a strong problem-solving mindset. My time at Sri Chaitanya laid a solid foundation for my further studies in computer science.",
      degree: "Intermediate - MPC (Mathematics, Physics, Chemistry)",
    },
    {
      id: 2,
      img: bhashyam,
      school: "Bhashyam High School, Kothavalasa",
      date: "Apr 2015 - March 2020",
      grade: "10 CGPA",
      desc: "I completed my Secondary Education (Class 5–10) at Bhashyam High School, Kothavalasa (State Board). My schooling provided a strong foundation in Mathematics, Science, and Computer Basics.",
      degree: "Secondary School Education (Class 5 - Class 10)",
    },
  ];
